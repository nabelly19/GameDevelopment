...
public class TrackingProjectileState : State
{
    ...
    public override void Act(Boss boss)
    {
        ...
        GameEngine.Current.AddObjectToCollisionList(
            new TrackingProjectile(
                "Bullet",
                boss.X,
                boss.Y,
                25 * ClientScreenSize.WidthFactor,
                25 * ClientScreenSize.WidthFactor,
                this.player,
                30,
                boss
...
public class PlatformState : State
{
    ...
    PointF[] spawns =
    {
        new PointF(465 * ClientScreenSize.WidthFactor, 390 * ClientScreenSize.HeightFactor),
        new PointF(465 * ClientScreenSize.WidthFactor, 910 * ClientScreenSize.HeightFactor),
        new PointF(1450 * ClientScreenSize.WidthFactor, 390 * ClientScreenSize.HeightFactor),
        new PointF(1450 * ClientScreenSize.WidthFactor, 910 * ClientScreenSize.HeightFactor),
    };
    ...
    public override void Act(Boss boss)
    {
        if (!isActivated)
        {
            ...
            this.platform = new(
                ...
                spawns[random].X,
                spawns[random].Y,
                290 * ClientScreenSize.WidthFactor,
                260 * ClientScreenSize.WidthFactor
            );
